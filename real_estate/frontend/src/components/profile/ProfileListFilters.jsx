...
export default function ProfileListFilters({ filters, setFilters }) {
  const handleChange = (e) => {
    switch (e.target.id) {
      case "assets":
        ...
        return;
      case "professions":
        let professions = filters.professions;
        ...
        setFilters({ ...filters, professions: professions });
        return;
      case "feet":
        setFilters({
          ...filters,
                      ...
                      return (
                        <div className="flex items-center mx-4 ">
                          <Checkbox
                            ...
                            checked={
                              filters.professions &&
                              filters.professions.includes(profession)
                            }
                          />
                          <label
                            htmlFor={profession}
